...
\begin{enumerate}
    ...
    \item Figure to Fig. 
    \item fig $\implies$  Fig.
    \item Intermediate data atoms $\implies$ results data atom.
    \item Results
    \item Fork and rename
    \item chord $\implies$ Chord
