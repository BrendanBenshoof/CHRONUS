...
\begin{figure}
    ...
    \caption{The larger the size of the job, the greater the gains of distributing with ChordReduce.  In addtion, the larger the job, the more workers can be added before we start seeing dimishing returns.  This demonstrates that ChordReduce is scalable.}
    \label{expSpeed}
\end{figure}
...
Our testing rates for churn are an order of maginitude higher that the rates used in the P2P-MapReduce simulation  \cite{marozzo2012p2p}.  We chose these rates to demonstrate that ChordReduce could effectively handle this higher level of churn.  
