...
In recent years, there has been a trend of crowdsourcing large and complicated tasks among willinparticipants.  Folding@home is a distributed program for simulating the complex molecular behaviors of various protiens  \cite{folding}.  The program has been a huge boon X research, providing data for BLANK publications as of DATE CITATION HERE.

In a similar vein, seti@home DOES X
 \cite{folding}
