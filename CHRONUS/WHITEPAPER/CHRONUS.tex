...
We ran our experiments on groups of 1, 10, 20, 30, and 40 nodes.  Each sized ring was asked to generate $med$ samples by default, with later tests generating on $small$ and $large$ samples.  
